...
**TL;DR:** Yes. You can do so by downloading the experimental version posted in [# changelog](https://discord.com/channels/1226193436521267223/1326278546175299614)

**Long answer:**

There are currently 2 modes to play in the experimental.
You can play hivemind which follows a team format with up to 8 people and up to 4 teams. 
Alternatively, there is also potluck which makes it so you are facing all players, and you have to beat the average score of the players to win
...
Currently, the mulitplayer mod is avaliable on most mod managers. However, it is recomendded to use the Balatro Multiplayer Installer since most mod managers 
update steamodded to the lastest version which is not the recommended steammodded version to run Balatro Multiplayer. 