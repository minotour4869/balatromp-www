...
- You must be on the latest version of Multiplayer and have The Order Integration enabled in Mods > Multiplayer > config
...
- You have to be on the recommended steammodded (506a). Not doing so will result in a strike or win given to your oppoenent. The easiest way to get the recommended steammodded is through the [Balatro Multiplayer Launcher](https://balatromp.com/docs/getting-started/installation), or through manually downloading it.
You can download the recomendded steammodded can be found [In this download link,](https://github.com/Steamodded/smods/archive/refs/tags/1.0.0-beta-0506a.zip)
