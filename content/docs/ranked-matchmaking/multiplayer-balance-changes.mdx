	...
	<table>
		...
		<tr>
			...
			<td>
				...
				<Money>$1</Money> for every <Money>$3</Money> your Nemesis spent in corresponding shop <Hands>last ante</Hands>
			</td>
			<td></td>
		</tr>
		<tr>
			...
			<td>
				This Joker gains <Mult>+4</Mult> Mult for every card your Nemesis <Hands>sold</Hands> since last <Hands>PvP Blind</Hands>, updates when <Hands>PvP Blind</Hands> is selected
			</td>
			<td></td>
		</tr>
		<tr>
